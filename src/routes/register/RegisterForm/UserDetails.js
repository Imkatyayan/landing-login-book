...
export default props => {
  ...
  let countryC = React.useRef(null)
  ...
  const handleChanges=(e)=>{
    setTimeout(() => {
      ...
      CountryList.map((option) => { if (option.name == CountryVal) { user.Countrycode = option.Iso; countryC.childNodes[1].firstElementChild.value=option.Iso } })   
    }, 1000);  
  };
  return (
